package com.runerealms.core.monad
...
public sealed class Either<Left, Right> private constructor() {
     ...
     */
    public fun getLeft(): Left = fold({ it }, { throw NoSuchElementException("Either.getRight() on Right") })

    /**
     * Returns the right value if it is present, otherwise throws [NoSuchElementException].
     */
    public fun getRight(): Right = fold({ throw NoSuchElementException("Either.getLeft() on Left") }, { it })
