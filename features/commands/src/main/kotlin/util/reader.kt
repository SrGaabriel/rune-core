...
/**
 * A simple string reader that allows for easy reading of strings.
 *
 * @property content The content to read.
 * @property index The current index of the reader.
 */
...
public inline fun <T> buildList(scope: MutableList<T>.() -> Unit): List<T> = mutableListOf<T>().apply(scope)